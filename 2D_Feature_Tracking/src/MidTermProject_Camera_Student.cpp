...
int main(int argc, const char *argv[])
{
    ...
    for (auto descriptorType : descriptorTypes) {
        ...
        for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
        {
            ...
            vector<cv::KeyPoint> selected_points;
            if (bFocusOnVehicle)
            {
            ...
            if (bVis)
            {
                ...
                string windowName = "Keypoint " + detectorType;
            ...
            if (dataBuffer.size() > 1) // wait until at least two images have been processed
            {
                ...
                //// EOF STUDENT ASSIGNMENT
                matches_size.push_back(matches.size());
        ...
        int total_matches = 0;
        cout << "Number of matches sizes:" << endl;
        for (auto val : matches_size) {
            cout << val << ",";
            total_matches += val;
        }
        cout << endl;
